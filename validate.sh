...
node scripture-burrito-develop/code/validate.js metadata derived-scripture-x/metadata.json
node scripture-burrito-develop/code/validate.js metadata derived-scripture-textTranslation/metadata.json
